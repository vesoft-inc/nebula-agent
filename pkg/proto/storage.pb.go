...
func (m *GS) Reset()         { *m = GS{} }
func (m *GS) String() string { return proto.CompactTextString(m) }
func (*GS) ProtoMessage()    {}
func (*GS) Descriptor() ([]byte, []int) {
	return fileDescriptor_0d2c4ccf1453ffdb, []int{2}
}
func (m *GS) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GS) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GS.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GS) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GS.Merge(m, src)
}
func (m *GS) XXX_Size() int {
	return m.Size()
}
func (m *GS) XXX_DiscardUnknown() {
	xxx_messageInfo_GS.DiscardUnknown(m)
}

var xxx_messageInfo_GS proto.InternalMessageInfo

func (m *GS) GetBucket() string {
	if m != nil {
		return m.Bucket
	}
	return ""
...
func (m *GS) GetCredentials() string {
	if m != nil {
...
type Backend_Gs struct {
	Gs *GS `protobuf:"bytes,3,opt,name=gs,proto3,oneof" json:"gs,omitempty"`
}

func (*Backend_Local) isBackend_Storage() {}
func (*Backend_S3) isBackend_Storage()    {}
func (*Backend_Gs) isBackend_Storage()    {}
...
func (m *Backend) GetGs() *GS {
	if x, ok := m.GetStorage().(*Backend_Gs); ok {
		return x.Gs
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*GS)(nil), "proto.GS")
...
var fileDescriptor_0d2c4ccf1453ffdb = []byte{
	...
	,
}
...
func (m *GS) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GS) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GS) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Credentials) > 0 {
		...
		i = encodeVarintStorage(dAtA, i, uint64(len(m.Credentials)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Path) > 0 {
...
func (m *Backend_Gs) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Backend_Gs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Gs != nil {
		{
			size, err := m.Gs.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GS) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GS: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GS: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Backend) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Gs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
